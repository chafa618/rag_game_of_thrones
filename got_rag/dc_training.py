...
def train(df):
    ...
    joblib.dump(clf, "models/dc_got_nb.pkl")  
...
def get_dc_cls():
    try:
        loaded_model = joblib.load("models/dc_got_nb.pkl")
        loaded_vectorizer = joblib.load("models/tfidf_vectorizer.pkl")
        return loaded_model, loaded_vectorizer
    except FileNotFoundError as e:
        logging.error(f"File not found: {e}")
        logging.warning('Ejecutar dc_training.train()')
...
def get_sentences():
    ...
    return common_sentences, got_sentences
